...
public class CVSClient implements Closeable {
    ...
    private static void printUsage() {
        ...
        System.out.println("  测试登录: jcvs login <标签>                        ");
        System.out.println("  检出模块: jcvs checkout <标签> <模块> <目录>        ");
        System.out.println("  提交修改: jcvs commit <标签>  <工作目录> -m <信息>   ");
        System.out.println("  查看差异: jcvs diff   <工作目录>               ");
        System.out.println("  更新目录或单个文件: jcvs update <标签> <目录或文件>           ");
        System.err.println("  添加文件: jcvs add <标签> /path/to/file.txt");
